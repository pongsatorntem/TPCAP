...
const U4 POLL_MS     = 10;     // 50 Hz
const U4 DEBOUNCE_MS = 40;     // 80 ms stable
...
static inline uint8_t read_hp_from_dip() {
  ...
  uint8_t dip = (r2 >> 5) & 0x0F;   // take bits 5–8 instead of 4–7
  DPRINT("[HP] r2=0x%04X dip=%u\n", r2, dip);
  return 9;
}
...
static constexpr int SERIAL_GUARD_CHANGE   = 0;
static constexpr int SERIAL_GUARD_SNAPSHOT = 0;
